...
const versionAddition = (argv, config) => {
	var _a;
	const additionalVersionFlags =
		(_a =
			config === null || config === void 0
				? void 0
				: config.pjson.oclif.additionalVersionFlags) !== null &&
		_a !== void 0
			? _a
			: [];
	const mergedVersionFlags = [
		...new Set(["--version", ...additionalVersionFlags]).values(),
	];
...
async function runCommand(argv = process.argv.slice(2), options) {
	...
	if (
		options &&
		((typeof options === "string" && options.startsWith("file://")) ||
			options instanceof url_2.URL)
	) {
	...
	if (
		...
		!((_a = argv[0]) === null || _a === void 0 ? void 0 : _a.includes(":"))
	)
