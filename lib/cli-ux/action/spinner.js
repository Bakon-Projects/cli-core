...
function color(s) {
    if (!supports_color_1.default)
        return s;
    const has256 = supports_color_1.default.stdout
        ? supports_color_1.default.stdout.has256
        : (process.env.TERM || "").includes("256");
    return has256
        ? `\u001B[38;5;104m${s}${deps_1.default.ansiStyles.reset.open}`
...
class SpinnerAction extends base_1.ActionBase {
    constructor() {
        ...
        this.type = "spinner";
        this.frames =
            spinners[process.platform === "win32" ? "line" : "dots2"].frames;
        this.frameIndex = 0;
    }
    _start() {
        this._reset();
    ...
    _reset() {
        ...
        this._write(this.std, deps_1.default.ansiEscapes.cursorLeft +
            deps_1.default.ansiEscapes.cursorUp(lines) +
            deps_1.default.ansiEscapes.eraseDown);
        this.output = undefined;
    }
    _lines(s) {
