...
export declare const ux: {
    ...
    readonly styledHeader: typeof import("@xibakon/cli-core/src/cli-ux/styled/header").default;
    readonly styledJSON: typeof import("@xibakon/cli-core/src/cli-ux/styled/json").default;
    readonly table: typeof Table.table;
    readonly tree: typeof import("@xibakon/cli-core/src/cli-ux/styled/tree").default;
    readonly open: typeof import("@xibakon/cli-core/src/cli-ux/open").default;
    readonly wait: (ms?: number) => Promise<unknown>;
    readonly progress: typeof import("@xibakon/cli-core/src/cli-ux/styled/progress").default;
    done(): Promise<void>;
